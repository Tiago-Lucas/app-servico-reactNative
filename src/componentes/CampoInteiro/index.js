...
export default function CampoInteiro({valor,estilos,acao}){
    ...
    return(
        <TextInput style={[estilosPadrao.campo,estilos]} keyboardType="number-pad" onChangeText={(novoValor) =>{atualiza(novoValor,acao)}} selectTextOnFocus value={numeroEmTexto}/>
    )
}